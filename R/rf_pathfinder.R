...
#' @param nodeeval number of nodes to be evaluated
#' @seealso \code{\link{rf_parcoor}} and \code{\link{rf_sankey}}
#' @export
rf_pathfinder <- function(rf, report.progress = TRUE, nodeeval){
  paths <- rf_all_paths(rf = rf, report.progress = report.progress, nodeeval)
